...
extension Reactive where Base == UITableView {
    func items<S, Cell, O>(cellClass klass: Cell.Type) -> (O) -> (@escaping (Int, S.Iterator.Element, Cell) -> Swift.Void) -> Disposable where S : Sequence, Cell : UITableViewCell, O : ObservableType, O.Element == S {
